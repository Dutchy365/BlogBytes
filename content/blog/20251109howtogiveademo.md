---
author: ""
title: "The demo shift: from FAB to BAF"
date: 2025-11-09
description: From inside-out features to outside-in value 
tags:
- demo
thumbnail: /images/20251109Howtogiveademo/00howtogiveademo.png
preview: /00howtogiveademo.png
images: 
- /00howtogiveademo.png
---

Let’s be honest.
You can prepare your demo perfectly.

You’ve tested the feature ten times.
You’ve got a backup video, screenshots, even a second laptop ready, just in case the Wi-Fi doesn't work.

But here’s the thing:
Even if everything works flawlessly, your demo can still fall flat.

Because a technically perfect demo isn’t necessarily a memorable one.
Without a story, your audience might remember what you did, but not why it mattered.
...
The audience was stunned by the possibilities of what the future might hold. The demo’s impact was so profound that, decades later, composers Mike Rouse and Ben Neill created an avant-garde opera called [The Demo](https://mikelrouse.com/the-demo/), entirely dedicated to Engelbart’s visionary presentation.

Watch 'The Mother of All Demos':

<a href="https://www.youtube.com/watch?v=yJDv-zdhzMY" target="_blank">
 <img src="http://img.youtube.com/vi/yJDv-zdhzMY/mqdefault.jpg" alt="Watch the video" width="500" height="300" border="10" />
</a>
...
2. **Advantage**: how does it work?  
3. **Benefit**: what’s in it for the user?

![FAB](/images/20251109Howtogiveademo/fab.png)
...
1. **Benefit** – start with the win for your audience.  
2. **Advantage** – briefly explain what makes that possible.  
3. **Feature** – only show the button, code, or interface once they already understand why it matters.  


![BAF](/images/20251109Howtogiveademo/baf.png)
...
1. **Problem**: relatable pain: “Ever notice how your team gets stuck in endless email threads?”  
2. **Need**: what should happen instead: “Imagine collaborating as if you’re sitting side by side.”  
3. **Benefit**: the result: “You see each other’s updates live, with no duplicate work.”  
4. **Feature**; how you built it: “We’ve added real-time co-editing to the document system.”  
...
1. **Start with context**: in one sentence: what problem were you trying to solve?  
2. **Make the need come alive**: describe the current state and why it’s a pain.  
3. **Show the benefit**: what changes now that this is here?  
4. **Then reveal the feature**: run it live, click through, let people *feel* it.
